...
for seed in ['1','2','3','4','5']:
	baseline = pd.read_csv(path_dataset+'aps_run_cl__random_c_3_seed_'+seed, names=['ap'])
	final_str += str(baseline.mean().values[0])+ "\t"
	for competing_scoring in ['_turns_c_3', '_utt_avg_words_c_3',\
						'_cand_docs_avg_words_c_3', 'max_dif_exact_match_q_d_c_3',\
						'max_dif_semantic_match_q_d_c_3', '_bert_avg_pred_scores_c_3',\
						'_bert_avg_loss_c_3']:
